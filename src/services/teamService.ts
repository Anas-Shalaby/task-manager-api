...
export const getTeams = async (filters: any, page: number, limit: number, user: any) => {
...
export const getTeamById = async (id: string, user: any) => {
...
export const createTeam = async (data: any, user: any) => {
...
export const updateTeam = async (id: string, data: any, user: any) => {
  if (!canManageTeam(user)) {
...
export const deleteTeam = async (id: string, user: any) => {
  if (!canManageTeam(user)) {
